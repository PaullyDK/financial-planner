# Financial Planner
A full-stack web app for tracking budgets and transactions. Also includes a retirement saving projection.
...
4. create a .env file in the root folder with your databases details (things highlighted in red will be unique for you):
```sh
DB_HOST=localhost
DB_USER=root
